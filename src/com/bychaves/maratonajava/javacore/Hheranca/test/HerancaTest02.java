...
public class HerancaTest02 {
    // 0 - Bloco de inicialização estático da superclasse é executada quando a JVM carregar a classe pai
    // 1 - Bloco de inicialização estático da subclasse é executada quando a JVM carregar a classe filha
    // 2 - Alocado espaço em memória para objeto da superclasse
    // 3 - Cada atributo de superclasse é criado e inicializado com valores defaut ou o que for passado
